  ...
  return (
    <View className="flex-1 items-center w-full">
      <View className="flex-1 w-full max-w-sm justify-start gap-12 px-4">
        ...
        <Text className="text-pastel-blue text-sm text-center">
        ...
        <View className="flex-1 items-center justify-center w-full">
          ...
          <View className="items-center mt-[-20px]">
            <View className="flex-row items-baseline gap-1">
              ...
              <Text className="text-xl text-white/45">/ 7</Text>
            </View>
            <Text className="text-[10px] tracking-widest font-bold uppercase mt-2 text-white/50">
              {label}
            </Text>
          </View>
        </View>
